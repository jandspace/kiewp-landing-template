...
var _CourseBox = __webpack_require__(11);

var _CourseBox2 = _interopRequireDefault(_CourseBox);

var _HideFormElement = __webpack_require__(12);

var _HideFormElement2 = _interopRequireDefault(_HideFormElement);
    ...
    _createClass(timer, [{
        ...
        value: function addTimer() {
            this.el.syotimer({
                ...
                periodic: false,
                lang: this.lang,
                afterDeadline: function afterDeadline() {
...
(function ($) {
    ...
    $.fn.syotimer = function (options) {
        ...
        var defaultTimer = {
            ...
            afterDeadline: function afterDeadline(timerBlock) {
        ...
        return el.each(function () {
            ...
            (function timeout() {
                ...
                if (settings.periodic) {
                    // ÐµÑÐ»Ð¸ Ð½Ð°Ð´Ð¾ Ð¾Ñ‚ÑÑ‡Ð¸Ñ‚Ñ‹Ð²Ð°Ñ‚ÑŒ Ñ‚Ð°Ð¹Ð¼ÐµÑ€ Ð¿Ð¾ Ð¿ÐµÑ€Ð¸Ð¾Ð´Ñƒ

                    // Ð¾Ð¿Ñ€ÐµÐ´ÐµÐ»ÑÐµÐ¼ ÐµÐ´Ð¸Ð½Ð¸Ñ†Ñƒ Ð¸Ð·Ð¼ÐµÑ€ÐµÐ½Ð¸Ñ Ð¿ÐµÑ€Ð¸Ð¾Ð´Ð° Ñ‚Ð°Ð¹Ð¼ÐµÑ€Ð°
                    switch (settings.periodUnit) {
                        case 'd':
                            unit_ms = day_ms;break;
                        case 'h':
                            unit_ms = hour_ms;break;
                        case 'm':
                            unit_ms = minute_ms;break;
                        case 's':
                            unit_ms = 1;break;
                    }
                    ...
                    } else dUnits = settings.periodInterval - differentUnits % settings.periodInterval;
                    ...
                    if (addUnits == 0 && different < 0) dUnits--;
    ...
    function init(elem, options) {
        // ÑƒÑÑ‚Ð°Ð½Ð¾Ð²ÐºÐ° html Ñ€Ð°Ð·Ð¼ÐµÑ‚ÐºÐ¸ Ð² Ð±Ð»Ð¾ÐºÐµ Ñ Ñ‚Ð°Ð¹Ð¼ÐµÑ€Ð¾Ð¼
    ...
    function format2(ANumber, isUse) {
        // Ñ„Ð¾Ñ€Ð¼Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ñ Ñ‡Ð¸ÑÐµÐ» Ñ Ð²ÐµÐ´ÑƒÑ‰Ð¸Ð¼Ð¸ Ð½ÑƒÐ»ÑÐ¼Ð¸
        isUse = isUse == '' ? isUse : true;
        return ANumber <= 9 && isUse ? "0" + ANumber : "" + ANumber;
    }
    function declOfNum(number, titles, lang) {
        // ÑƒÑÑ‚Ð°Ð½Ð¾Ð²ÐºÐ° Ð¿Ñ€Ð°Ð²Ð¸Ð»ÑŒÐ½Ð¾Ð³Ð¾ ÑÐºÐ»Ð¾Ð½ÐµÐ½Ð¸Ñ Ð¿Ð¾ÑÐ»Ðµ Ñ‡Ð¸ÑÐ»Ð¸Ñ‚ÐµÐ»ÑŒÐ½Ñ‹Ñ…
        switch (lang) {
            case 'rus':
                cases = [2, 0, 1, 1, 1, 2];
...
exports.default = HideFormElement;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
